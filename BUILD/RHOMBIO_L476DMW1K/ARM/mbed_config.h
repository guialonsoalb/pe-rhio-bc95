...
#define LPTICKER_DELAY_TICKS                                                  4                                                                                                // set by target:RHOMBIO_L476DMW1K
...
#define MBED_CONF_APP_BUTTON_PRESSED_STATE                                    0                                                                                                // set by application[RHOMBIO_L476DMW1K]
#define MBED_CONF_APP_FLASH_SIZE                                              (1024*1024)                                                                                      // set by application[RHOMBIO_L476DMW1K]
#define MBED_CONF_APP_FLASH_START_ADDRESS                                     0x08000000                                                                                       // set by application[RHOMBIO_L476DMW1K]
...
#define MBED_CONF_UPDATE_CLIENT_APPLICATION_DETAILS                           (MBED_CONF_APP_FLASH_START_ADDRESS + 64*1024)                                                    // set by application[RHOMBIO_L476DMW1K]
...
#define MBED_CONF_UPDATE_CLIENT_STORAGE_ADDRESS                               (2*1024*1024)                                                                                    // set by application[RHOMBIO_L476DMW1K]
#define MBED_CONF_UPDATE_CLIENT_STORAGE_LOCATIONS                             1                                                                                                // set by application[RHOMBIO_L476DMW1K]
#define MBED_CONF_UPDATE_CLIENT_STORAGE_PAGE                                  512                                                                                              // set by library:update-client
#define MBED_CONF_UPDATE_CLIENT_STORAGE_SIZE                                  (2*1024*1024)                                                                                    // set by application[RHOMBIO_L476DMW1K]
...
#define PAL_INTERNAL_FLASH_SECTION_1_ADDRESS                                  (MBED_CONF_APP_FLASH_START_ADDRESS + MBED_CONF_APP_FLASH_SIZE - 2*(2*1024))                      // set by application[RHOMBIO_L476DMW1K]
#define PAL_INTERNAL_FLASH_SECTION_1_SIZE                                     (2*1024)                                                                                         // set by application[RHOMBIO_L476DMW1K]
#define PAL_INTERNAL_FLASH_SECTION_2_ADDRESS                                  (MBED_CONF_APP_FLASH_START_ADDRESS + MBED_CONF_APP_FLASH_SIZE - 1*(2*1024))                      // set by application[RHOMBIO_L476DMW1K]
#define PAL_INTERNAL_FLASH_SECTION_2_SIZE                                     (2*1024)                                                                                         // set by application[RHOMBIO_L476DMW1K]
